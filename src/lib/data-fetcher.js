...
export async function fetchHomeData() {
  return fetchDocCached("websites/radioimmunoassayin/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/radioimmunoassayin/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/radioimmunoassayin/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/radioimmunoassayin/districts/${district}`);
}
